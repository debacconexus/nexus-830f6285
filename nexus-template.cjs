...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Multi-Jurisdictional Emergency Health Response Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Emergency Response Incident";
process.env.TABLE_NAME = process.env.TABLE_NAME || "emergency_response_incident_records";
'use strict';
